            ...
            {isOpen && (
                <div className="absolute top-16 right-0 z-50">
                    ...
                    >
                      ...
                      `}
                                        >
                                            <div className={`mt-1.5 w-2 h-2 rounded-full flex-shrink-0 ${notification.read ? 'bg-transparent' : 'bg-primary'}`} />

                                            <div className="flex-1 min-w-0">
                                                <div className="flex justify-between items-start">
                                                    <h4 className={`text-sm ${notification.read ? 'font-medium' : 'font-bold'} text-text-primary truncate`}>
                                                        {notification.title}
                                                    </h4>
