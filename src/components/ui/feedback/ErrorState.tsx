...
import { type ReactNode, forwardRef, type HTMLAttributes, Component, type ErrorInfo } from 'react';
      ...
      >
        ...
        {details && (
          ...
          >
            ...
            <pre className="mt-2 overflow-auto whitespace-pre-wrap">{details}</pre>
          </details>
        )}
