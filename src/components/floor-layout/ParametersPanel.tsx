      ...
      <div className="px-2 py-2">
        ...
        <div className="grid grid-cols-1 gap-3">
          <div className="flex flex-col p-3 rounded-2xl bg-surface border border-glass-border">
            <span className="text-[10px] text-text-muted uppercase font-bold tracking-wider mb-1">
              Operators
            </span>
      ...
      <div className="card-float p-3">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center justify-between bg-surface p-1 rounded-lg border border-glass-border">
            <button
              onClick={() =>
                inputs.buildingFloors > 1 &&
                onInputChange('buildingFloors', inputs.buildingFloors - 1)
              }
            ...
            <span className="text-xs font-bold text-text-primary">
              ...
              <span className="text-[10px] font-normal text-text-muted">floors</span>
            </span>
            <button
      ...
      <div className="card-float p-3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="text-[10px] text-center text-text-muted bg-surface/50 rounded py-1">
            Total Area:{' '}
            <strong>{(inputs.floorWidth * inputs.floorHeight).toLocaleString()} m²</strong>
          </div>
        </div>
      </div>
    </motion.div>
