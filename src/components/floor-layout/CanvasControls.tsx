  ...
  return (
    ...
    >
      ...
      <div className="px-2 py-1 text-center">
        <span className="text-[10px] font-bold text-text-primary">{zoomPercentage}%</span>
      </div>
      ...
      {/* Fit to Screen */}
      <ControlButton icon={<Maximize2 size={16} />} onClick={onFitToScreen} title="Fit to Screen" />

      {/* Reset View */}
      <ControlButton icon={<RotateCcw size={16} />} onClick={onResetView} title="Reset View" />
