                        ...
                        <div className="space-y-5">
                            ...
                            <div className="relative z-30">
                                <TimePicker
                                    ...
                                    value={`${Math.floor(inputs.workingHoursPerDay)}:${Math.round((inputs.workingHoursPerDay % 1) * 60).toString().padStart(2, '0')}`}
                                    onChange={(time) => {
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center gap-2 text-xs text-[var(--color-text-muted)]">
                                    <Gauge size={12} />
                                    <span>
                                        {inputs.punchCount < 5000 ? 'Simple' : inputs.punchCount < 15000 ? 'Medium' : inputs.punchCount < 35000 ? 'Complex' : 'Very Complex'} design
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2 relative z-40">
                                <div className="flex items-center justify-between">
                                    <label className="text-sm font-medium text-[var(--color-text-secondary)]">Thread Colors</label>
                                    <span className="text-sm font-semibold text-[var(--color-text-primary)]">{inputs.threadColors} colors</span>
                                </div>
                                <ColorPicker
