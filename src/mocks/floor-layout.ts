...
export const productTypes: ProductType[] = [
    ...
    },
    {
        ...
        spaceModifier: 1.15,
        departments: ['warehouse', 'cutting', 'sewing', 'embroidery', 'finishing', 'packing', 'utilities'],
        icon: '🧥',
    },
    {
        id: 'pt-cs',
    ...
    },
    {
        ...
        spaceModifier: 1.1,
        departments: ['warehouse', 'cutting', 'sewing', 'sublimation', 'finishing', 'packing', 'utilities'],
        icon: '🎽',
    },
];
