...
export const mockMachineTypes: MockMachineType[] = [
    // Sewing Machines
    { id: 'mt-001', name: 'Single Needle Lockstitch', category: 'sewing', defaultSpeed: 5000, defaultEfficiency: 0.85 },
    { id: 'mt-002', name: 'Double Needle Lockstitch', category: 'sewing', defaultSpeed: 4500, defaultEfficiency: 0.82 },
    { id: 'mt-003', name: 'Overlock 3-Thread', category: 'sewing', defaultSpeed: 7000, defaultEfficiency: 0.88 },
    { id: 'mt-004', name: 'Overlock 5-Thread', category: 'sewing', defaultSpeed: 6500, defaultEfficiency: 0.85 },
    { id: 'mt-005', name: 'Flatlock/Coverstitch', category: 'sewing', defaultSpeed: 5500, defaultEfficiency: 0.80 },
    { id: 'mt-006', name: 'Bartack', category: 'sewing', defaultSpeed: 3000, defaultEfficiency: 0.90 },
    { id: 'mt-007', name: 'Button Attach', category: 'sewing', defaultSpeed: 1500, defaultEfficiency: 0.92 },
    { id: 'mt-008', name: 'Buttonhole', category: 'sewing', defaultSpeed: 1200, defaultEfficiency: 0.90 },

    // Embroidery Machines
    { id: 'mt-101', name: 'Barudan BEXT-S1501C', category: 'embroidery', defaultSpeed: 1000, defaultEfficiency: 0.85 },
    { id: 'mt-102', name: 'Barudan BEXT-S1506C', category: 'embroidery', defaultSpeed: 950, defaultEfficiency: 0.83 },
    { id: 'mt-103', name: 'SWF MA-6', category: 'embroidery', defaultSpeed: 1100, defaultEfficiency: 0.82 },
    { id: 'mt-104', name: 'Brother PR1050X', category: 'embroidery', defaultSpeed: 1000, defaultEfficiency: 0.85 },
    { id: 'mt-105', name: 'Tajima TFMX-IIC', category: 'embroidery', defaultSpeed: 1200, defaultEfficiency: 0.88 },

    // Cutting Machines
    { id: 'mt-201', name: 'Auto Cutter - Single Ply', category: 'cutting', defaultSpeed: 0, defaultEfficiency: 0.95 },
    { id: 'mt-202', name: 'Auto Cutter - Multi Ply', category: 'cutting', defaultSpeed: 0, defaultEfficiency: 0.92 },
    { id: 'mt-203', name: 'Band Knife', category: 'cutting', defaultSpeed: 0, defaultEfficiency: 0.85 },

    // Finishing Machines
    { id: 'mt-301', name: 'Steam Press', category: 'finishing', defaultSpeed: 0, defaultEfficiency: 0.90 },
    { id: 'mt-302', name: 'Fusing Machine', category: 'finishing', defaultSpeed: 0, defaultEfficiency: 0.92 },
    { id: 'mt-303', name: 'Thread Trimmer', category: 'finishing', defaultSpeed: 0, defaultEfficiency: 0.95 },
];
...
export function calculateMockResults(inputs: CalculatorInputs): CalculatorOutputs {
    ...
    const availableDays = Math.max(1, Math.ceil((deadline.getTime() - today.getTime()) / (1000 * 60 * 60 * 24)));
