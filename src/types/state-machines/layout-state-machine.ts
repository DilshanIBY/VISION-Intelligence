 ...
 */
export const LAYOUT_STATES: readonly LayoutState[] = ['editing', 'validated', 'exported'] as const;
 ...
 */
export function canTransitionLayout(currentState: LayoutState, targetState: LayoutState): boolean {
 ...
 */
export function getAllowedLayoutTransitions(currentState: LayoutState): readonly LayoutState[] {
